...
from webssh.handler import IndexHandler, WsockHandler, NotFoundHandler, SMTPHandler, DownloadHandler, UploadHandler
...
def make_handlers(loop, options):
    ...
    handlers = [
        ...
        (r'/smtp', SMTPHandler, dict(loop=loop)),
        (r'/smtp/download', DownloadHandler, dict(loop=loop)),
        (r'/smtp/upload', UploadHandler, dict(loop=loop)),
